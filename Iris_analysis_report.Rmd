...
``` {r sepal length, fig.width=4, fig.height=4}
#Sepal length
...
```{r sepal_width, fig.width=4, fig.height=4}
...
```{r petal length, fig.width=4, fig.height=4}
...
```{r petal width, fig.width=4, fig.height=4}
